 ...
 *
 */
namespace $679_24_game {
  /**
   * @param {number[]} nums
   * @return {boolean}
   */
  export const judgePoint24 = function(nums: number[]) {
    const value = nums.sort().join('');
    return !falseValue.has(value);
  };
  const falseValue = new Set<string>([
    '1111',
    '1112',
    '1113',
    '1114',
